...
from src.data import MentalAttentionNounGroundingDataLoader as Loader
from src.models import MentalAttentionNoundGroundingModel as Grounder
...
def main(args):
    ...
    for key, val in files.items():
        data_loader[key] = Loader(val, batchsize=args.batch_size,ignore_language_model=args.ignore_captions)
