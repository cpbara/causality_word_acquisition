...
python3 test_full_action_classifier.py --pretrained_model=models/basic_causal_action_classifier_50.torch 
...
python3 test_full_action_classifier.py --pretrained_model=models/pr_bbox_causal_action_classifier_50.torch --bbox_type='pr_bbox'
...
python3 test_full_action_classifier.py --pretrained_model=models/gt_bbox_causal_action_classifier_50.torch --bbox_type='gt_bbox'
...
python3 test_full_action_classifier.py --pretrained_model=models/mental_attention_action_classifier_50.torch --attention_model=models/mental_attention_model.torch
